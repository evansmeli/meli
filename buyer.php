...
<header id="header">
  ...
  <div class="dropdown-content">
    ...
    <a href="#">Settings</a>
    <a href="logout.php">Sign Out Out</a>
  </div>
</div>
</div>
</header>
            ...
            foreach ($results as $key => $value) {
                    ...
                    <form class="item-desc">
                        <div class="details">
                            ...
                            <fieldset>
                                <label for="item3" class="label-desc">Price</label>
                                <input type="text" name="item3" value="'.$value->price.'" readonly class="text-no-edit">
                            </fieldset>
                            <fieldset>
                                <label for="item4" class="label-desc">Plot No.</label>
                                <input type="text" name="item4" value="'.$value->number.'" readonly class="text-no-edit">
                            </fieldset>
                        </div>
                        <div class="action">
                            <fieldset>
